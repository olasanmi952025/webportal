...
const Checkbox: React.FC<CheckboxProps> = ({
  ...
  return (
    <div className="group relative flex items-start p-3 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-all duration-200 cursor-pointer">
      ...
      <div className="ml-3 flex-1">
        <label
          htmlFor={id}
          className={`
            block text-sm font-semibold leading-5 transition-colors duration-200
            ${disabled 
              ? 'text-gray-400 dark:text-gray-500 cursor-not-allowed' 
              : 'text-gray-900 dark:text-gray-100 cursor-pointer hover:text-blue-600 dark:hover:text-blue-400'
            }
          `}
        ...
        {description && (
          <p
            id={`${id}-description`}
            className={`
              mt-1 text-xs leading-4 transition-colors duration-200
              ${disabled 
